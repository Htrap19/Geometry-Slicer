...
export function LandingPage({ onFileSelected }: LandingPageProps) {
  ...
  return (
    <div
      className={`fixed inset-0 z-50 flex flex-col items-center justify-center gap-6 bg-neutral-50/70 dark:bg-neutral-950/70 backdrop-blur-sm text-neutral-900 dark:text-neutral-100 px-6 transition-opacity duration-500 ${
